...
#'
#' @param distance_matrix Numeric matrix of distances between protected areas in kilometers,
#'   typically generated by [ec_pa_distances()]
#' @param median_dispersal Numeric. Median dispersal distance of the focal species or
#'   species group in kilometers. Default is 10 km
#'
#' @return A numeric matrix of dispersal probabilities where element represents
...
#'
#' @export
ec_dispersal_probability <- function(distance_matrix,
                                     median_dispersal = 10) {

  prob_matrix <- exp(-log(2)*distance_matrix / median_dispersal)
  # Set diagonal to 1 (within-patch probability)
  diag(prob_matrix) <- 1
